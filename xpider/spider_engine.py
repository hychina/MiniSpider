import ConfigParser
from demo import spiders
from spider import Spider
from xpider.database import Database
...
class SpiderEngine:
    ...
    def run(cls, spider_cfg):
        ...
        # initialize spiders
        parser_pkg = __import__('spiders', fromlist=spiders.__all__)
        parsers_ = dict()
        for parser_mod_name in spiders.__all__:
